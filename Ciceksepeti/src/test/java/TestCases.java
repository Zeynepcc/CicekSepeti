...
public class TestCases extends BaseConfigPage {
	...
	public void registerNullTest() throws InterruptedException
	{
		...
		assertNotEquals(driver.findElement(By.id("NameIndivual-error")).getText(),"Bu bilginin doldurulmasý zorunludur.");
	}
	@Test
	...
	public void LoginTest() throws InterruptedException
	{
		...
		assertEquals(driver.findElement(By.xpath("//span[text()='Hesabým']")).getText(),"Hesabým");
	}
	@Test
	...
	public void CardInfoNullTest() throws InterruptedException
	{
		...
		if(driver.findElement(By.xpath("//*[@id=\"GroupDeliveryAddressList_0__Address_AddressLine-error\"]")).getText() == "Bu bilginin doldurulmasý zorunludur." ||
				driver.findElement(By.xpath("//*[@id=\"GroupDeliveryAddressList_0__Address_Phone_Phone-error\"]")).getText() == "Bu bilginin doldurulmasý zorunludur.")
		{
		  assertTrue(true);
		} 
		new HomePage(driver).RemoveProduct();
	...
	public void BillNullTest() throws InterruptedException
	{
		...
		.productAddCardByAdress("Ýstanbul")
		.callHomePage()
		.callCardPage().CardInfo("Zeynep Turhan", "05422800925","Ýstanbul/Ümraniye").CardBillInfo(" ", " ");
		if(driver.findElement(By.id("BuyerName-error")).getText() == "Bu bilginin doldurulmasý zorunludur." ||
				driver.findElement(By.id("PhoneNumber")).getText() == "Bu bilginin doldurulmasý zorunludur.")
		{
		  assertTrue(true);
		}
		new HomePage(driver).RemoveProduct();
	...
	public void BillInfoNavigateTest() throws InterruptedException
	{
		...
		.productAddCardByAdress("Ýstanbul")
		.callHomePage()
		.callCardPage().CardInfo("Zeynep Turhan", "05422800925","Ýstanbul/Ümraniye").CardBillInfo("Zeynep Turhan", "05422800925");
		new HomePage(driver).RemoveProduct();
	}
	@Test
	...
	public void DeleteProductTest() throws InterruptedException
	{
		...
		assertEquals(driver.findElement(By.tagName("h1")).getText() , "Sepetinizde ürün bulunmamaktadýr.");
